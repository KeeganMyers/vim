...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias dark='xrandr --output DP-5 --brightness 0.6;xrandr --output DP-0 --brightness 0.6; xrandr --output DP-3 --brightness 0.6'
    alias average='xrandr --output DP-5 --brightness 0.8;xrandr --output DP-0 --brightness 0.8; xrandr --output DP-3 --brightness 0.8'
    alias bright='xrandr --output DP-5 --brightness 1.0;xrandr --output DP-0 --brightness 1.0; xrandr --output DP-3 --brightness 1.0'
fi
